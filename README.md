...
Data scientist in Bangalore, on the Global Payments team at Razorpay. Since 2022 I've built ML and analytics systems in fintech and ride-hailing — fraud detection, churn prediction, an adaptive RL router, and an LLM analyst that answers a team's data questions from its own wiki.
